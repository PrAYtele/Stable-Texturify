...
textures_path = config["inpaint_textures"]
...
textures = {
    ...
    'right': bpy.data.images.load(filepath=textures_path["right"])
}
...
output_texture_path = os.path.join(output_folder, "projected_texture_inpaint.png")
